...
echo wget -P $DATA_DOWNLOAD_DIRECTORY --debug  -N  -A *.gz,*.html -r -l 2 $CAIDA_DATA_DIRECTORY_URL --exclude-directories=$CAIDA_DATA_DIRECTORY/1,$CAIDA_DATA_DIRECTORY/2,$CAIDA_DATA_DIRECTORY/3,$CAIDA_DATA_DIRECTORY/4,$CAIDA_DATA_DIRECTORY/5
