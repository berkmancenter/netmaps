...
<li>Add up the connected IPs represented by all of the traversed ASs together, taking care to count children ASs appropriately (do not count ASs in the traversed list as children, and only include a proportional share of children ASs whose parents are not all in the traversed list).</li>
